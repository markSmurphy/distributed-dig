module.exports = {
    helpScreen: function () {
        ...
        console.log('   ' + 'ddig --list-resolvers                 ' + 'List resolvers configured in ddig.json '.grey);
        console.log('   ' + 'ddig --list-options                   ' + 'List DNS request options configured in ddig.json '.grey);
